...
type UserRepositoryMock interface {
	...
	UpdateRepository(userBody *models.User, id string) (*models.User, error)
...
func (u *IuserRepositoryMock) UpdateRepository(userData *models.User, id string) (*models.User, error) {
